        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={person.name}
                className="bg-white p-8 rounded-xl border border-brand-muted/30"
              >
                <div className="w-16 h-16 rounded-full bg-brand-cyan flex items-center justify-center mb-4">
          ...
          {[
            {
              year: "1972",
              event:
                "Byers Electrical Construction founded in Franklinville, NJ",
            },
            {
              year: "2004",
            ...
            },
            {
              year: "2017",
              event:
                "Byers expands to nationwide operations across 25 states",
            },
            {
              year: "2024",
              event:
                "Data One launches as Europe's first giga-scale AI data center platform",
            },
            {
              year: "2025",
              event:
                "Byers delivers Phase 1 of the Vineland 300 MW data center in 20 weeks",
            },
            {
              year: "2026",
              event:
                "DataOne Construction formed — the self-contained electrical construction division",
            },
          ].map((item, i) => (
            <div key={i} className="flex gap-6 items-start">
              ...
              <p className="text-gray-600 pb-4">{item.event}</p>
            </div>
          ))}
        </div>
      </section>
