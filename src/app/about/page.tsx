          ...
          <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white rounded-xl overflow-hidden border border-brand-muted/30">
              <div className="relative h-48 sm:h-56">
                <Image
                  src="/images/service-conceptualize.png"
                  alt="Data One vision"
                  fill
                  className="object-cover"
                />
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-brand-muted/30">
              <div className="relative h-48 sm:h-56">
                <Image
                  ...
                  alt="Byers Industrial construction"
                  fill
                  className="object-cover"
                />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div
                key={person.name}
                className="bg-white rounded-xl border border-brand-muted/30 overflow-hidden"
              >
                {person.image ? (
                  <div className="relative h-56 sm:h-64 bg-brand-cyan">
                    <Image
                      src={person.image}
                      alt={person.name}
                      fill
                  ...
                  <div className="h-56 sm:h-64 bg-brand-cyan flex items-center justify-center">
                    <span className="text-brand font-bold text-4xl">
                      {person.name
                        .split(" ")
                        .map((n) => n[0])
                        .join("")}
