        ...
        <div className="bg-brand-cyan rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="p-12 md:p-16">
              ...
              <p className="mt-2 text-gray-600">Vineland, New Jersey</p>
            ...
            <div className="bg-gradient-to-br from-brand/10 to-brand-muted/30 p-12 md:p-16 flex flex-col justify-center">
              <h3 className="font-bold text-gray-900 mb-6">Scope of Work</h3>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={item.sector}
              className="text-center p-6 rounded-xl bg-brand-cyan"
            >
              <p className="text-3xl font-bold text-brand">{item.count}</p>
              <p className="text-sm text-gray-600 mt-1">{item.sector}</p>
            </div>
          ))}
        </div>
      </section>
